...
class TestPageLayout:
    ...
    def test_page_loads(self, page: Page, base_url: str):
        ...
        page.goto(base_url)
        expect(page).to_have_title("Garage Cam")
    ...
    def test_top_bar_elements(self, page: Page, base_url: str):
        ...
        status_icon = page.locator(".camera-name .status-icon")
        ...
        expect(hdr_status).to_contain_text("HDR:")
...
class TestStatusIndicators:
    ...
    def test_status_circle_color(self, page: Page, base_url: str):
        ...
        classes = status_icon.get_attribute("class")
        assert any(status in classes for status in ["status-ok", "status-error", "status-stopped"])
